...
#
# Created: Thu Jan 26 13:30:44 2012
...
class Ui_ChangementViewer(object):
    def setupUi(self, ChangementViewer):
        ...
        self.pushButtonStop = QtGui.QPushButton(self.layoutWidget)
        self.pushButtonStop.setMaximumSize(QtCore.QSize(16, 16))
        ...
        self.pushButtonStop.setIconSize(QtCore.QSize(33, 33))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/back.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/forward.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButtonToggleTime.setIcon(icon4)
