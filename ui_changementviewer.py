...
#
# Created: Tue Feb  7 13:42:38 2012
...
class Ui_ChangementViewer(object):
    def setupUi(self, ChangementViewer):
        ...
        self.btnQ = QtGui.QPushButton(self.layoutWidget1)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btnQ.sizePolicy().hasHeightForWidth())
        self.btnQ.setSizePolicy(sizePolicy)
        self.btnQ.setMinimumSize(QtCore.QSize(18, 18))
        ...
        self.btnQ.setFlat(True)
        self.btnQ.setObjectName(_fromUtf8("btnQ"))
